...
ENV CONTENTFUL_DELIVERY_ACCESS_TOKEN=secret/soosap/website/CONTENTFUL_DELIVERY_ACCESS_TOKEN
ENV CONTENTFUL_MANAGEMENT_ACCESS_TOKEN=secret/soosap/website/CONTENTFUL_MANAGEMENT_ACCESS_TOKEN
ENV CONTENTFUL_PREVIEW_ACCESS_TOKEN=secret/soosap/website/CONTENTFUL_PREVIEW_ACCESS_TOKEN
